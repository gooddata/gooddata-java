...
import com.gooddata.sdk.model.workspace.Environment;
import com.gooddata.sdk.model.workspace.WorkspaceDriver;
import com.gooddata.sdk.model.workspace.WorkspaceEnvironment;
import com.gooddata.sdk.model.workspace.Workspaces;
...
/**
 * Workspace in GoodData platform
 */
...
public class Workspace {
    ...
    public Workspace(String title, String authorizationToken) {
        content = new WorkspaceContent(authorizationToken);
        meta = new WorkspaceMeta(title);
    }

    public Workspace(String title, String summary, String authorizationToken) {
        content = new WorkspaceContent(authorizationToken);
        meta = new WorkspaceMeta(title, summary);
    }

    @JsonCreator
    private Workspace(@JsonProperty("content") WorkspaceContent content, @JsonProperty("meta") WorkspaceMeta meta,
    ...
    public void setWorkspaceTemplate(String uri) {
        meta.setWorkspaceTemplate(uri);
    }
    ...
    public void setDriver(WorkspaceDriver driver) {
    ...
    public void setEnvironment(final WorkspaceEnvironment environment) {
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    @JsonInclude(JsonInclude.Include.NON_NULL)
    private static class WorkspaceContent {
        ...
        public WorkspaceContent(final String authorizationToken) {
            this.authorizationToken = authorizationToken;
            guidedNavigation = "1";
            driver = WorkspaceDriver.POSTGRES.getValue();
        }

        @JsonCreator
        public WorkspaceContent(@JsonProperty("authorizationToken") String authorizationToken,
    ...
    private static class WorkspaceMeta extends Meta {

        private String workspaceTemplate;

        @JsonCreator
        private WorkspaceMeta(@JsonProperty("author") String author,
        ...
        private WorkspaceMeta(String title) {
            super(title);
        }

        private WorkspaceMeta(String title, String summary) {
            super(title, summary);
        }
