...
public class GoodDataToStringBuilderTest {
    ...
    @Test
    public void testToStringExcludeNonRecursive() throws Exception {
     ...
     */
    @Test
    public void testToStringExcludeRecursive() {
    ...
    static class TestClass {
        ...
        public String toString() {
            return GoodDataToStringBuilder.toStringExclude(this, "toBeExcludedField", "anotherToBeExcludedField");
        }
    }
